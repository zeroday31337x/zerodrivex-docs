    ...
    >
      ...
      <div className="mb-12 p-8 rounded-xl border border-white/10 bg-white/5 text-center max-w-3xl mx-auto">
        ...
        <p className="text-white/70 text-sm leading-relaxed">
          This documentation portal contains research papers, technical
          specifications, and architecture documentation for the ZeroDriveX
          AI ecosystem including ZDX AI, ZDX Mobile AI, and ZDX Guard.
        </p>
      ...
      <div className="grid md:grid-cols-3 gap-4 mb-12">
        ...
        >
          ...
          <p className="text-xs text-white/60">
            Core AI infrastructure and research
          </p>
        </a>
